...
const answerKeys = [new AnswerKey(), new AnswerKey(), new AnswerKey(), new AnswerKey(), new AnswerKey()];
...
class TryoutTest extends Component {
  ...
  render() {
    ...
    // TRYOUT 5 KEY ANSWERS
    answerKeys[4].setTryoutId("5");
